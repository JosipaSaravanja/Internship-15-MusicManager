...
new newAlbum("Remek Depo","Beograd (2) ", "Electronic", 1983, new Date("1983-1-1")),//nisam nasla datum*/
  new newAlbum("b", "b", "Rock", 12, new Date("2021-1-1")),
  new newAlbum("a", "b", "Rock", 11, new Date("2021-1-1")),
  new newAlbum("z", "a", "rock", 10, new Date("2021-1-1")),
  new newAlbum("t", "a", "Rock", 9, new Date("2021-1-1")),
  ...
  new newAlbum("b", "b", "Rock", 4, new Date("2023-3-11")),
  new newAlbum("a", "b", "Rock", 3, new Date("2023-1-1")),
  new newAlbum("e", "a", "Rock", 2, new Date("2023-1-1")),
  new newAlbum("d", "a", "Rock", 1, new Date("2023-1-1")),
];
